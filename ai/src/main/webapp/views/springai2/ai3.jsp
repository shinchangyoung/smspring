...
<script>
    ...
    `;
            ...
            const response = await fetch('/ai2/generic-bean-output-converter', {
                method: "post",
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'Accept': 'application/json'
                },
                body: new URLSearchParams({ cities: question })
            });
...
<div class="col-sm-10">
    ...
    <div class="row">
        <div class="col-sm-8">
            <textarea id="question" class="form-control">서울시, 부산시</textarea>
        </div>
        <div class="col-sm-2">
