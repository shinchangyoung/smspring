...
<script>
    // ai5 JavaScript 객체: AI 관련 기능을 캡슐화합니다.
    let ai5 = {
    ...
    `;
            ...
            // fetch API를 사용하여 서버의 '/ai1/prompt-template'으로 POST 요청을 보냅니다.
            const response = await fetch('/ai1/prompt-template', {
                ...
                // 요청 본문에 'statement'와 'language' 파라미터를 담아 전송합니다.
    ...
    $(()=>{
        // ai5 객체의 init 함수를 호출하여 페이지를 초기화합니다.
        ai5.init();
    });
