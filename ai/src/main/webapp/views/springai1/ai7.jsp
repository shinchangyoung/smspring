...
<script>
    // ai8 JavaScript 객체: AI 관련 기능을 캡슐화합니다. (파일 이름은 ai7.jsp이지만 스크립트 내 객체 이름은 ai8로 되어 있습니다)
    let ai8 = {
        ...
        // send 함수: 사용자 질문을 서버로 비동기 전송하고 스트리밍 응답을 처리합니다.
        send: async function(){
            // 스피너를 표시하여 사용자에게 로딩 중임을 알립니다.
            $('#spinner').css('visibility','visible');

            // 사용자가 입력한 질문 내용을 가져옵니다.
    ...
    `;
            ...
            // fetch API를 사용하여 서버의 '/ai1/step-back-prompt'으로 POST 요청을 보냅니다.
            const response = await fetch('/ai1/step-back-prompt', {
                ...
                // 요청 본문에 'question' 파라미터를 담아 전송합니다.
    ...
    $(()=>{
        // ai8 객체의 init 함수를 호출하여 페이지를 초기화합니다.
        ai8.init();
    });
