...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <c:choose>
            <c:when test="${sessionScope.admin.adminId == null}">
            ...
            <c:otherwise>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value="/inquiry" />">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>1:1 문의 관리</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<c:url value="/loginimpl?id=${sessionScope.admin.adminId}"/> ">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>${sessionScope.admin.adminId}님</span></a>
                </li>
            </c:otherwise>
        </c:choose>
        <!-- Divider -->
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <a class="btn btn-primary" href="<c:url value="/logoutimpl"/>">Lgout</a>
            </div>
        </div>
    </div>
</div>
